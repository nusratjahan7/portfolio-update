    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                initial="hidden"
                animate="visible"
                className="hidden md:flex md:flex-col absolute right-4 lg:right-16 top-1/2 -translate-y-1/2 gap-5 max-w-[160px]"
            >
                {[
            ...
            {/* Scroll indicator */}
            <div className="hidden md:flex absolute right-6 top-1/3 items-center gap-2 text-xs tracking-widest uppercase text-(--muted) font-['Space_Mono',monospace] [writing-mode:vertical-rl]">
                <motion.div
                    variants={scrollDown}
                    animate="animate"
